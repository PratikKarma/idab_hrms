    ...
    public function index(Request $request)
    {
        ...
        if (Auth::user()->type == 'company' || Auth::user()->type == 'super admin') {
            ...
            if ($user->type == 'super admin') {
                ...
                return view('setting.company_settings', compact('settings', 'timezones', 'ips', 'shift_turner', 'EmailTemplates', 'currOfferletterLang', 'Offerletter', 'offerlang', 'Joiningletter', 'currjoiningletterLang', 'joininglang', 'experience_certificate', 'curr_exp_cetificate_Lang', 'explang', 'noc_certificate', 'currnocLang', 'noclang', 'webhooks', 'offerlangName', 'joininglangName', 'explangName', 'noclangName'));
            }
        } else {
