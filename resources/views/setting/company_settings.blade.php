        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <div class="d-flex align-items-center">
                    <h5 class="mb-0 me-3">{{ __('IP Restriction Settings') }}</h5>
...
<script>
    ...
    document.getElementById('ip_restrict').addEventListener('change', function() {
        document.getElementById('ipRestrictForm').submit();
    });
</script>
@endsection