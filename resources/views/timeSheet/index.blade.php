                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                        <div class="btn-box">
                                            ...
                                            {{ Form::text('start_date', isset($_GET['start_date']) ? $_GET['start_date'] : \Carbon\Carbon::now()->format($company_settings['site_date_format']), ['class' => 'month-btn form-control datepicker w-100', 'autocomplete' => 'off', 'id' => 'current_date']) }}
                                        </div>
                                    </div>
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                        <div class="btn-box">
                                            {{ Form::label('end_date', __('End Date'), ['class' => 'form-label']) }}
                                            {{ Form::text('end_date', isset($_GET['end_date']) ? $_GET['end_date'] : \Carbon\Carbon::now()->format($company_settings['site_date_format']), ['class' => 'month-btn form-control datepicker w-100', 'autocomplete' => 'off', 'id' => 'current_date']) }}    
                                        </div>
                                    </div>
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                        <div class="btn-box">
